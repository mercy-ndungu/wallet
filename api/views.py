...
from digiwallet.models import *
#from .serializers import AccountSerilaizers, CardSerilaizers, CustomerSerilaizers, LoanSerilaizers, 
# NotificationsSerilaizers, ReceiptSerilaizers, TransactionSerilaizers, WalletSerilaizers
from .serializers import TransactionSerilaizers, AccountSerilaizers, CardSerilaizers, CustomerSerializers, LoanSerilaizers, NotificationsSerilaizers, WalletSerilaizers, ReceiptSerilaizers
